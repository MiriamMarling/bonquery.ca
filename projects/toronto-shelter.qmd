...
sourceNote = {
  ...
  return html`<div class="bq-warn" style="margin:0.5rem 0 1rem;font-size:0.88em">
    <p style="margin:0">
      ...
      webpage</a>. Offline stays blank until the detailed file is published.
    </p>
  </div>`
}
```
