...
étiquette les deux sources de la Ville](data-validation.html){target="_blank"}.
...
La page Web et le fichier de données ouvertes peuvent être publiés à des moments
différents et peuvent utiliser des extractions ou des définitions différentes.
[Voir comment BonQuery combine et étiquette les deux
